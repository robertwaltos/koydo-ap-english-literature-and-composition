...
export const metadata: Metadata = {
  title: "Pricing — Ap English Literature And Composition Premium",
  description: "Unlock unlimited Ap English Literature And Composition practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=ap-english-literature-and-composition&cadence=annual`;
    ...
    <main className="min-h-screen px-4 py-12">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h1 className="mb-4 text-3xl font-bold text-zinc-900 dark:text-zinc-100">
          Ap English Literature And Composition Premium
        </h1>
