// Auto-generated shim — re-exports from @/lib/ap-english-literature-and-composition/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _ap_english_literature_and_composition_Config } from "@/lib/ap-english-literature-and-composition/config";
import { EXAM_CONFIG as _raw } from "@/lib/ap-english-literature-and-composition/config";
